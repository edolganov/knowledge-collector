...
public class JOptionPaneExt extends JOptionPane implements Accessible
{
	
	public static interface InitListener {
		void onInit(JDialog dilaog);
	}
	
	private static InitListener listener;
	
	public static void setListener(InitListener l){
		listener = l;
	}
     ...
     * use the options from the <code>JOptionPaneExt</code>.
     */
     ...
     * <code>JOptionPaneExt.UNINITIALIZED_VALUE</code> to ensure the
    ...
    private JDialog createDialog(Component parentComponent, String title,
        ...
        Window window = JOptionPaneExt.getWindowForComponent(parentComponent);
    ...
    private void initDialog(final JDialog dialog, int style, Component parentComponent) {
        ...
        dialog.addComponentListener(new ComponentAdapter() {
            public void componentShown(ComponentEvent ce) {
                ...
                setValue(JOptionPaneExt.UNINITIALIZED_VALUE);
            }
        });
        addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent event) {
                ...
                if (dialog.isVisible() && event.getSource() == JOptionPaneExt.this &&
                  (event.getPropertyName().equals(VALUE_PROPERTY)) &&
                  event.getNewValue() != null &&
                  event.getNewValue() != JOptionPaneExt.UNINITIALIZED_VALUE) {
                    dialog.setVisible(false);
                }
            }
        });
        if(listener != null){
        	listener.onInit(dialog);
        }
    ...
    public static void showInternalMessageDialog(Component parentComponent,
        ...
        showInternalMessageDialog(parentComponent, message, UIManager.
                                 ...
                                 parentComponent.getLocale()), INFORMATION_MESSAGE);
    }
    ...
    public static String showInternalInputDialog(Component parentComponent,
        ...
        return showInternalInputDialog(parentComponent, message, UIManager.
               getString("OptionPane.inputDialogTitle", parentComponent.getLocale()),
               QUESTION_MESSAGE);
    }
     ...
     * and wrapping the <code>JOptionPaneExt</code>.
    ...
    public JInternalFrame createInternalFrame(Component parentComponent,
                                 String title) {
        Container parent =
                JOptionPaneExt.getDesktopPaneForComponent(parentComponent);

        if (parent == null && (parentComponent == null || 
                (parent = parentComponent.getParent()) == null)) {
            throw new RuntimeException("JOptionPaneExt: parentComponent does " +
                    "not have a valid parent");
        }
        ...
        addPropertyChangeListener(new PropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent event) {
                ...
                // (newValue = null in that case).  Otherwise, close the dialog.
                if (iFrame.isVisible() &&
                        event.getSource() == JOptionPaneExt.this &&
                        event.getPropertyName().equals(VALUE_PROPERTY)) {
    ...
    public static Frame getFrameForComponent(Component parentComponent) 
        ...
        return JOptionPaneExt.getFrameForComponent(parentComponent.getParent());
    }
    ...
    static Window getWindowForComponent(Component parentComponent) 
        ...
        return JOptionPaneExt.getWindowForComponent(parentComponent.getParent());
    }
    ...
    /**
     * Creates a <code>JOptionPaneExt</code> with a test message.
     */
    public JOptionPaneExt() {
        this("JOptionPaneExt message");
    }

    /**
     * Creates a instance of <code>JOptionPaneExt</code> to display a
     * message using the 
    ...
    /**
     * Creates an instance of <code>JOptionPaneExt</code> to display a message
     ...
     * in the created <code>JOptionPaneExt</code>.
     *
     * @param message the <code>Object</code> to display
     * @param messageType the type of message to be displayed:
     *                  <code>ERROR_MESSAGE</code>, 
    ...
    public void setMessageType(int newType) {
        if(newType != ERROR_MESSAGE && newType != INFORMATION_MESSAGE &&
           ...
           newType != PLAIN_MESSAGE)
            throw new RuntimeException("JOptionPaneExt: type must be one of JOptionPaneExt.ERROR_MESSAGE, JOptionPaneExt.INFORMATION_MESSAGE, JOptionPaneExt.WARNING_MESSAGE, JOptionPaneExt.QUESTION_MESSAGE or JOptionPaneExt.PLAIN_MESSAGE");
    ...
    public void setOptionType(int newType) {
        if(newType != DEFAULT_OPTION && newType != YES_NO_OPTION &&
           newType != YES_NO_CANCEL_OPTION && newType != OK_CANCEL_OPTION)
            throw new RuntimeException("JOptionPaneExt: option type must be one of JOptionPaneExt.DEFAULT_OPTION, JOptionPaneExt.YES_NO_OPTION, JOptionPaneExt.YES_NO_CANCEL_OPTION or JOptionPaneExt.OK_CANCEL_OPTION");
    ...
    /**
     * Returns a string representation of this <code>JOptionPaneExt</code>.
     * This method 
     ...
     * be <code>null</code>.
     * 
     * @return  a string representation of this <code>JOptionPaneExt</code>
     */
...
///////////////////
    ...
    /**
     * Returns the <code>AccessibleContext</code> associated with this JOptionPaneExt. 
     * For option panes, the <code>AccessibleContext</code> takes the form of an 
     * <code>AccessibleJOptionPaneExt</code>. 
     * A new <code>AccessibleJOptionPaneExt</code> instance is created if necessary.
     *
     * @return an AccessibleJOptionPaneExt that serves as the 
     *         AccessibleContext of this AccessibleJOptionPaneExt
     * @beaninfo
     *       expert: true
    ...
    public AccessibleContext getAccessibleContext() {
        if (accessibleContext == null) {
            accessibleContext = new AccessibleJOptionPaneExt();
        }
     ...
     * <code>JOptionPaneExt</code> class.  It provides an implementation of the 
     ...
     */
    protected class AccessibleJOptionPaneExt extends AccessibleJComponent {
    ...
    } // inner class AccessibleJOptionPaneExt
}
